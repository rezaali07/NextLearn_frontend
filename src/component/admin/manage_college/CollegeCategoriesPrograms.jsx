...
//     setCategoryForm({ name: cat.name, image: null });
...
//                     <td>{cat.name}</td>
//                     <td>
//                       <button className="btn btn-delete" onClick={() => deleteCategory(cat.slug)}>Delete</button>
//                       <button className="btn btn-add" style={{ backgroundColor: "#007bff" }} onClick={() => editCategory(cat)}>Edit</button>
//                     </td>
//                   </tr>
//                 ))}
//               </tbody>
...
//                     <td>{prog.name}</td>
//                     <td>
//                       <button className="btn btn-delete" onClick={() => deleteProgram(prog.slug)}>Delete</button>
//                       <button className="btn btn-add" style={{ backgroundColor: "#007bff" }} onClick={() => editProgram(prog)}>Edit</button>
//                     </td>
//                   </tr>
//                 ))}
//               </tbody>
